...
Undersøgelsen er tilrettelagt med fokus på sporbarhed, konsistens og analytisk holdbarhed. Tilgangen kombinerer dokumentanalyse af regulatoriske krav med empirisk sektorviden, en casebaseret pilot og en analyse af en MVP som artefakt. Det muliggør en kobling mellem policy, organisatorisk praksis og teknisk operationalisering af ESG-krav.

Metoden kobler regulative krav, empirisk sektorviden og artefaktanalyse, så MVP'en kan anvendes som empirisk grundlag i vurderingen af implementering og beslutningsrelevans.
...
Triangulering opnås ved at sammenholde regulatoriske dokumenter, empiriske sektorkilder og interne case- og softwarekilder. Det giver et samlet billede af, hvordan standarder, governance og praktiske constraints former ESG-rapportering for SMV'er i sundhedssektoren. OECD peger på fragmenterede ESG-data og begrænset sammenlignelighed, hvilket styrker behovet for at krydstjekke krav, sektorviden og praksisbaserede artefakter.\parencite{OECD2020ESG,Berg2022AggregateConfusion}
...
Sporbarhed sikres gennem dokumenteret case- og softwaremateriale (bilag \ref{app:teknisk-dokumentation}).
