...
Den teoretiske ramme gør tre ting: den forklarer ESG som \textit{standardiseringspraksis}, viser hvordan policy omsættes til organisatorisk handling, og vurderer økonomisk relevans og kommercialiseringsmuligheder. Rammen integrerer (1) \textit{standardisering} og organisationer med afsæt i Brunsson, (2) policy- og \textit{governance}perspektiver med fokus på \textit{translasjon} og institutionel styring, og (3) økonomiske og kommercielle perspektiver på \textit{værdiskabelse} og performance. Tilsammen udgør de et analysekatalog, der bruges til at fortolke empirien og vurdere MVP'ens rolle.
...
\textcite{BrunssonWorldOfStandards} beskriver standarder som organiserede regler og forventninger, der skaber ensartethed og sammenlignelighed på tværs af organisationer. Underafsnittet afklarer \textit{standardiseringens} dobbelte rolle: legitimitet gennem fælles forventninger og risiko for \textit{dekobling}, når efterlevelse bliver formel. Standardisering er ikke kun teknisk, men også institutionel: den etablerer, hvad der betragtes som legitim praksis, og skaber et fælles sprog for kontrol, måling og rapportering.
\begin{displayquote}
...
\textbf{Standarder kan samtidig fungere som styring på afstand.} De gør det muligt at koordinere aktører, der ikke deler samme kontekst, men de skaber også risiko for, at organisationer fokuserer på formel overholdelse frem for substantiel forandring. Brunsson formulerer det sådan: \enquote{The mere existence of a standard does not guarantee that it will be followed.} Det åbner for \textit{dekobling} mellem det, der rapporteres, og det, der faktisk gøres i praksis. ESG-ratingdivergens dokumenteret af \textcite{Berg2022AggregateConfusion} understøtter, at standardisering ikke automatisk giver konsensus om kvalitet eller performance.

I ESG-rapportering betyder det, at standarder definerer, hvilke indikatorer og narrativer der opfattes som gyldig dokumentation. Det fremmer auditabilitet og sammenlignelighed, men kan også reducere rapportering til et compliance-projekt. For SMV'er er standardisering derfor både en forudsætning for legitim rapportering og en byrde, der kræver ressourcer, struktur og data. ESG-as-a-Service kan ses som en standardiseringsinfrastruktur, der omsætter krav til konkrete datafelter og arbejdsgange, men den kan også forstærke fokus på minimumskrav frem for strategisk læring. Analytisk peger det på en vurdering af faktisk praksisændring versus symbolsk efterlevelse.

Implementering af standarder forudsætter \textit{governance} og \textit{translasjon}, fordi krav omsættes lokalt gennem institutionelle mekanismer og organisatoriske fortolkninger. Det leder videre til de policy- og governanceperspektiver, som analyserer denne oversættelse.
...
\textcite{RoevikTrenderTranslasjoner} beskriver, hvordan ideer og styringskoncepter vandrer mellem organisationer og bliver oversat til lokale praksisser. \textcite{TranslationTheoryKnowledgeTransfer} viser, at implementering ikke er en ren kopiering, men en proces, hvor krav redigeres, omformuleres og tilpasses til organisatoriske betingelser. Det betyder, at ensartede standarder kan skabe variation i praksis, afhængigt af aktørers kapacitet, fortolkning og incitamenter.
\begin{displayquote}
...
Det økonomiske perspektiv starter med spørgsmålet om virksomhedens formål. \textcite{Friedman1970Profits} argumenterer for, at virksomhedens primære ansvar er at maksimere profit inden for lovens rammer, mens \textcite{Freeman1984Stakeholder} betoner ansvar over for flere interessenter end aktionærerne. \textcite{Carroll1991Pyramid} uddyber dette gennem en CSR-pyramide, hvor økonomiske, juridiske, etiske og filantropiske hensyn kombineres i virksomhedens ansvar. Business Roundtable's 2019-erklæring signalerer et skifte mod \textit{stakeholder}-ansvar, formuleret i \textcite{BusinessRoundtable2019}, men \textcite{Economist2022Broken} peger på, at sådanne forpligtelser kan være symbolske uden stærk \textit{governance} og målelige mål.

I et bredere værdiskabelsesperspektiv fremhæver \textcite{Elkington1998TripleBottomLine}, at bæredygtighed skal vurderes på tværs af økonomi, miljø og sociale forhold (\textit{triple bottom line}). \textcite{PorterKramer2011CSV} argumenterer for, at virksomheder kan skabe \textit{shared value} ved at koble samfundsmæssige udfordringer til forretningsstrategi og innovation. Disse perspektiver tilbyder et begrebsligt fundament for at vurdere, om ESG-indsatser kan skabe varig værdi frem for at være rene omkostninger.

Empirisk peger metastudier af \textcite{Eccles2014Impact} og \textcite{Friede2015Meta} på en overvejende positiv eller neutral sammenhæng mellem ESG og finansiel performance, men effekten varierer med kontekst og tidsperiode. \textcite{Khan2016Materiality} viser, at finansielt \textit{materielle} ESG-temaer er forbundet med bedre performance, mens immaterielle temaer ikke har samme effekt. Det peger på, at værdien af ESG-arbejde afhænger af strategisk fokus og relevans.
...
\textbf{Det betyder, at ESG-as-a-Service ikke kun skal vurderes på compliance, men også på om løsningen reducerer risici, forbedrer beslutningsgrundlag og skaber økonomisk nytte for SMV'er.} Det informerer vurderingen af betalingsvillighed, prisstruktur og den kommercielle bæredygtighed af servicekonceptet.

Perspektiverne definerer tilsammen de centrale kriterier for analysen og fungerer som det teoretiske afsæt for de efterfølgende kapitler.
\subsection{Opsamling af den teoretiske ramme}
\label{subsec:opsamling-af-den-teoretiske-ramme}

Den teoretiske ramme samler tre komplementære perspektiver, der tilsammen forklarer, hvorfor ESG-rapportering opfattes som nødvendig, hvordan den implementeres, og hvilke økonomiske konsekvenser den kan have. *Standardisering* bidrager med begreber om legitimitet og sammenlignelighed, \textit{governance} forklarer oversættelse af policy til praksis, og økonomiske perspektiver adresserer \textit{værdiskabelse} og betalingsvillighed.
...
Analysen tager især afsæt i to spændinger: (1) \textit{standardiseringens} løfte om legitimitet versus risikoen for \textit{dekobling}, og (2) \textit{compliance}-logik versus beslutningsrelevant ESG som styringsgrundlag. Det skaber en eksplicit ramme for at vurdere, om ESG-as-a-Service omsætter krav til praksis eller primært producerer dokumentation.
