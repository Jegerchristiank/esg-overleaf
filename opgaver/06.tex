...
Dataindtastningen foregår modul for modul. Et konkret eksempel på udfyldt input i et energimodul fremgår af figur \ref{fig:app-b2-udfyldt}, mens figur \ref{fig:app-b2-trace} dokumenterer beregningslogikken, der gør resultatet efterprøvbart. Supplerende skærmbilleder af tomt modul og beregnet CO$_2$-estimat fremgår af bilag \ref{app:supplerende-figurer-og-tabeller} (figurer \ref{fig:app-b2-tomt} og \ref{fig:app-b2-resultat}). Slutpunktet er en review-side, hvor rapportstatus og eksportmuligheder fremgår (figur \ref{fig:app-review-topoverblik}).
