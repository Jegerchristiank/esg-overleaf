...
Traceability-matricen fra afsnit \ref{subsec:traceability-matrice} fungerer som reference for, hvilke felter der skal indsamles, valideres og logges i auditspor; fuld matrix fremgår af bilagstabel \ref{tab:traceability-matrix-full}.
...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{l r r l X}
    \toprule
    Scenarie & $n_{\text{total}}$ & $n_{\text{fuldfort}}$ & $C_{\text{trace}}$ & Udfyldte auditfelter \\
    \midrule
    Energi (B2) & 5 & 5 & 100\% & Tidsstempel, kilde-ID, valideringslog, EF-version, sign-off. \\
    Affald (C5) & 5 & 5 & 100\% & Tidsstempel, fraktionskilde, valideringslog, beregningsspor, sign-off. \\
    \bottomrule
  \end{tabularx}
  \TableSource{Egen fremstilling.}
