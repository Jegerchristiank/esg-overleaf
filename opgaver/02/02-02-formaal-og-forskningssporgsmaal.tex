...
Kontekstkapitlet etablerer grundlaget for spørgsmål~1, softwarekapitlet konkretiserer spørgsmål~3, og analysen samler svarene i et sammenhængende argument om værdiskabelse og governance.
Spørgsmålene besvares i \ref{sec:analyse}, diskuteres i \ref{sec:diskussion} og sammenfattes i \ref{sec:konklusion}.
