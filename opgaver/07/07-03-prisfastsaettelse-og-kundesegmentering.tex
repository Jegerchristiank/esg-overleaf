...
Et konkret break-even-scenarie kan illustreres med månedlige størrelser: Hvis $F=\num{36000}$~kr./md., $V=\num{400}$~kr./kunde/md., $m=\num{300}$~kr., og en målpris $P=\num{2500}$~kr. for basissegmentet, fås $N_{\text{BE}} = F / (P - V - m) \approx \num{20}$ kunder. Scenariet viser, at relativt få kunder kan dække de faste omkostninger, men at prisfølsomhed i basissegmentet hurtigt påvirker bæredygtigheden i modellen.
...
\begin{table}[t]
  \caption{Illustrativ prisdifferentiering på kundesegmenter.}
