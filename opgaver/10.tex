...
\begin{itemize}
  \item VSME-standarden sænker startniveauet, så SMV'er kan begynde med basismodul og gradvist udvide rapporteringen i takt med bedre datakvalitet og ressourcer.\parencite{Virksomhedsguiden2025VSMEIntro,Erhvervsstyrelsen2025ESGTemplate}
  ...
  \item Stop-the-clock udskyder tidsplaner og bør derfor behandles som en tidsbuffer til at etablere datagrundlag og \textit{governance}-strukturer.\parencite{Erhvervsstyrelsen2025StopClock}
\end{itemize}
