...
\begin{itemize}
  \item Ifølge \textcite{Virksomhedsguiden2025VSMEIntro} giver VSME et lavt startniveau; SMV'er kan derfor starte med basismodul og gradvist udvide rapporteringen, efterhånden som datakvalitet og ressourcer forbedres. \textcite{Virksomhedsguiden2025VSMEModules} og \textcite{Virksomhedsguiden2025NoDualMateriality} uddyber, at basismodullets datapunkter er designet som minimumsniveau uden krav om dobbelt væsentlighed.
  \item Fokus bør ligge på materielle temaer (energi, affald, arbejdsmiljø), hvor \textcite{Khan2016Materiality} finder størst effekt og relevans.
  ...
  \item Stop-the-clock bør ikke tolkes som en pause, men som en tidsbuffer til at etablere datagrundlag og governance-strukturer, i tråd med \textcite{Erhvervsstyrelsen2025StopClock}.
\end{itemize}
