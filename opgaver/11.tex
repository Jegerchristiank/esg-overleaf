...
Bilagene understøtter sporbarhed og dokumentation for undersøgelsens metode og software. Bilagene gør to ting: de samler supplerende figurer og tabeller og uddyber den tekniske dokumentation. Bilag \ref{app:supplerende-figurer-og-tabeller} samler supplerende figurer og tabeller, som refereres fra hovedteksten, og bilag \ref{app:teknisk-dokumentation} uddyber den tekniske dokumentation. Bilagsdokumentet udgør det bedømmelsesrelevante evidensgrundlag med indholdsfortegnelse og stabile labels, så alle henvisninger kan følges i bilaget. Programkoden er kun et supplement og er tilgængelig via GitHub.
...
Den detaljerede software-specifikation er udeladt, og programkoden er tilgængelig som supplement via GitHub.
