...
Den analytiske spændvidde i ESG-as-a-Service kan tydeliggøres ved at skelne mellem minimum compliance og beslutningsrelevant ESG. Tabel \ref{tab:compliance-vs-beslutningsrelevant} opsummerer forskelle i formål, datakrav og organisatorisk anvendelse.
\begin{table}[t]
  \caption{Kontrast mellem minimum compliance og beslutningsrelevant ESG.}
