...
Som gennemgående analysegreb anvendes traceability-matricen (tabel \ref{tab:traceability-matrix}), så sammenhængen mellem retskilde, datapunkt, beregning og auditspor kontrolleres eksplicit i vurderingen af governance og værdiforslag.
