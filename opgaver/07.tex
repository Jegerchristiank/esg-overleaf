...
\textcite{BrunssonWorldOfStandards} beskriver standarder som regler, der skaber ensartethed og legitimitet, men som ikke automatisk følges i praksis. I sundhedssektoren fungerer ESG-krav som en sådan standardiseringsramme: de definerer, hvad der tæller som gyldig dokumentation, og hvilke indikatorer der skal måles. Ifølge \textcite{HCWH2019ClimateFootprint} og \textcite{WHO2024HealthCareWaste} skaber sektorens kompleksitet og datafragmentering en risiko for dekobling mellem rapportering og faktisk praksis. Ratingdivergens dokumenteret af \textcite{Berg2022AggregateConfusion} viser, at standarder alene ikke sikrer sammenlignelighed, hvilket øger betydningen af datakvalitet og sporbarhed.

\textcite{RoevikTrenderTranslasjoner} og \textcite{TranslationTheoryKnowledgeTransfer} understreger, at ideer og krav altid oversættes til lokale praksisser og forandres i processen. Det betyder, at ESG-rapportering i SMV'er ikke bliver en direkte implementering af ESRS/GRI, men en lokal tilpasning, hvor ressourcer, kompetencer og datasystemer afgør, hvad der reelt kan rapporteres. Case-materialet viser en tilsvarende prioritering af energi, affald og sociale KPI'er som operationel kerne frem for fuld dækning af alle standardkrav (bilag \ref{app:teknisk-dokumentation}).
...
Betalingsvilligheden er tæt knyttet til compliancepres og interessentkrav. Ifølge \textcite{PwC2025GuideESGSMV} og \textcite{Erhvervsstyrelsen2025StopClock} møder mange SMV'er dataanmodninger fra kunder og finansielle aktører og vælger derfor frivillig rapportering som risikoreduktion. \textcite{Finanstilsynet2025ESGRisk} peger på ESG som en stigende risikofaktor i kreditvurdering, hvilket gør bankkrav til en strukturel driver for betalingsvillighed. \textcite{GrantThorntonDK2025BankESG} underbygger, at bankernes ESG‑krav allerede påvirker kreditdialogen. \textcite{EY2025VSME} indikerer, at mange virksomheder rapporterer ud over basismodullets krav, hvilket peger på en villighed til at investere i bedre datakvalitet.
...
Samtidig er der tydelige incitamenter. Regulering og forsyningskædekrav driver rapporteringsbehov, og ifølge \textcite{Sepetis2024Healthcare} og \textcite{Bosco2024ESGHealth} kan ESG og digital transformation styrke sektorens bæredygtighed og robusthed. \textcite{Vegro2025OneHealth} underbygger, at sundhedssektoren har et særligt ansvar for at koble miljø og sociale hensyn, hvilket forstærker behovet for systematisk implementering.
