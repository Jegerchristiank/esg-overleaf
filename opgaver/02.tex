...
I \textcite{EU2022CSRD} fastlægges, at CSRD integrerer bæredygtighedsrapportering i den formelle ledelsesberetning og kræver digital tagging, hvilket flytter rapporteringen fra narrativ til auditerbar data. \textcite{EU2023ESRS} konkretiserer kravene gennem datapunkter og dobbelt væsentlighed og gør datagrundlag og materialitetsproces til en styringsopgave snarere end en kommunikationsøvelse. \textcite{GRI2021} fungerer samtidig som et globalt frivilligt supplement uden bindende karakter, hvilket understreger behovet for en praktisk oversættelse i SMV-konteksten.

Den gennemgående argumentation er, at regulative krav skaber en kløft mellem standarder og operationel datapraksis i SMV'er, og at ESG-as-a-Service kan fungere som en oversættelsesmekanisme, der reducerer denne kløft. Krav og kontekst danner udgangspunktet; teori, metode og MVP konkretiserer oversættelsen til praksis og gør det muligt at vurdere, hvornår rapportering bliver beslutningsrelevant frem for symbolsk.
\subsection{Baggrund og motivation}
\label{subsec:baggrund-og-motivation}

Ifølge \textcite{HCWH2019ClimateFootprint} bidrager sundhedssektoren globalt med ca. 4,4~\% af de samlede netto-udledninger, svarende til omtrent 2~Gt CO$_2$e. Mere end halvdelen af klimaaftrykket kommer fra energiforbrug, og udledningerne fordeler sig omtrent som 17~\% scope~1, 12~\% scope~2 og 71~\% scope~3. Det understreger sektorens afhængighed af indirekte udledninger i forsyningskæder og drift og peger på, at leverandør- og indkøbsdata bliver afgørende for rapporteringskvaliteten, selv i mindre organisationer.

Affaldsprofilen er en anden central dimension. Ifølge \textcite{WHO2024HealthCareWaste} klassificeres omtrent 85~\% af sundhedssektorens affald som ikke-farligt, mens ca. 15~\% er farligt (infektiøst, kemisk eller radioaktivt). Opdelingen indikerer, at affaldsdata må være fraktionsspecifikke for at kunne dokumentere compliance og risikostyring.

Den sociale dimension er ligeledes betydningsfuld. Ifølge \textcite{WHO2021HealthWorkerDeaths} er mindst 115.500 dødsfald blandt sundheds- og omsorgspersonale registreret over 18 måneder under COVID-19. Det peger på arbejdsvilkår og sikkerhed som en integreret del af ESG-arbejdet i sektoren og understreger behovet for sociale indikatorer, der kan dokumentere både forebyggelse og organisatorisk ansvarlighed.
