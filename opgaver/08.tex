...
Evidensgrundlaget er stærkt for de regulatoriske krav og de teoretiske perspektiver, men mere begrænset empirisk, fordi sektordata er aggregerede og casen er single-case. Det betyder, at alternative forklaringer og implikationer for SMV'er må vurderes kritisk, og at konklusionerne bør forstås som analytiske snarere end generaliserbare. Ifølge \textcite{Economist2022Broken} og \textcite{Winston2022Tumultuous} præges ESG-markedet af uensartede standarder og uklar performance-måling, hvilket forstærker behovet for sporbarhed og datakvalitet i praktisk implementering.
...
Ifølge \textcite{RoevikTrenderTranslasjoner} og \textcite{TranslationTheoryKnowledgeTransfer} oversættes ideer altid til lokale praksisser. Det genfindes i casen, hvor MVP'en prioriterer et begrænset sæt af indikatorer (energi, affald og sociale KPI'er) for at gøre rapporteringen gennemførbar for SMV'er. Dette bekræfter, at implementering ikke er en direkte kopi af ESRS/GRI, men en kontekstualiseret oversættelse.
...
Regulatorisk usikkerhed er en tredje forklaring. Det fremgår af \textcite{EU2022CSRD}, \textcite{EU2023ESRS} og \textcite{EU2020Taxonomy}, at rammerne er under løbende justering, og \textcite{Erhvervsstyrelsen2025StopClock} peger på, at stop-the-clock-aftalen kan skabe midlertidige tilpasninger i virksomhedernes prioriteringer. Effekter, der i analysen tolkes som implementeringsbarrierer, kan derfor delvist skyldes timing og regulatorisk bevægelse.
