...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.9\textwidth}
    ...
    \end{mdframed}
  \end{minipage}
  \caption{EU's styringslogik som arkitektur for ESG-rapportering.}
