...
\begin{table}[htbp]
  \caption{Traceability-matrice (udsnit), der binder retskilde, datapunkt, datafelter og auditspor.}
  ...
  \TableNote{Udsnittet er illustrativt og viser princippet; den fulde matrix udvides i MVP- og evalueringsafsnittene.}
\end{table}
