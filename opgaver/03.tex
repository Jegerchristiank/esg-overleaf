...
ESG-rapportering i sundhedssektoren er en styringsopgave med høj kompleksitet, fordi data og ansvar er fordelt på drift, forsyningskæder og arbejdsmiljø. \textcite{Sepetis2024Healthcare} viser, at sektoren må koble bæredygtighedsarbejde med digital transformation og klare processer for at kunne dokumentere resultater og ansvar, mens \textcite{Bosco2024ESGHealth} underbygger behovet gennem sektorspecifikke proceskort. \textcite{Vegro2025OneHealth} peger på, at ESG-rammer overlapper med bredere sundheds- og miljøhensyn, hvilket gør \textit{governance} til en tværgående data- og procesdisciplin snarere end en ren \textit{compliance}-opgave.

\textcitefull{HCWH2019ClimateFootprint}, \textcitefull{WHO2024HealthCareWaste} og \textcitefull{WHO2021HealthWorkerDeaths} dokumenterer, at sektorens klimaaftryk er domineret af scope~3, at affaldsprofilen kræver fraktionsspecifik dokumentation, og at arbejdsmiljørisici er empirisk veldokumenterede. Det betyder, at rapporteringen skal kunne samle leverandør-, affalds- og arbejdsmiljødata i konsistente formater, også for SMV'er med begrænset datakapacitet.
...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \endgroup
  \TableSource{\parenciteshort{HCWH2019ClimateFootprint,WHO2024HealthCareWaste,WHO2021HealthWorkerDeaths}}
\end{table}

\textbf{Samlet peger empiri og litteratur på, at ESG-rapportering i sundhedssektoren må dække både direkte driftstal og indirekte forhold i forsyningskæden samt sociale og organisatoriske risici.} Det skaber et behov for standardiserede processer, der kan omsætte kvalitative krav til sammenlignelige data og sporbar dokumentation, og gør de regulatoriske rammer til en central drivkraft.
\subsection{Regulatoriske rammer: CSRD, EU-taksonomien og GRI}
\label{subsec:regulatoriske-rammer-csrd-eu-taksonomien-og-gri}

De regulatoriske rammer for ESG-rapportering i EU består af flere sammenhængende elementer. \textcitefull{EU2022CSRD} udvider rapporteringspligten og gør bæredygtighedsrapportering til en integreret del af virksomhedernes officielle rapportering. Direktivet fastsætter, at rapporteringen skal ske efter ESRS, som er vedtaget som delegerede standarder, og at oplysningerne leveres i et standardiseret, digitalt format med XBRL-tagging (standardiseret digitalt tag-format), jf. \textcitefull{EU2023ESRS}. Implementeringen er trinvist indfaset og politisk justeret gennem den såkaldte stop-the-clock-aftale.\parencite{Erhvervsstyrelsen2025StopClock}

Indfasningen og de politiske justeringer betyder, at virksomheder skal planlægge rapportering under bevægelige rammer, hvor tidsplaner og præciseringer ændres over tid.\parencite{Erhvervsstyrelsen2025StopClock} Det gør fortolkning og prioritering til en reel del af compliance-arbejdet, særligt for SMV'er med begrænset kapacitet.

\textcitefull{EU2023ESRS} konkretiserer, hvilke oplysninger virksomhederne skal levere, og giver struktur til sammenhængen mellem strategi, risici, mål og resultater. Standarderne operationaliserer kravet om dobbelt væsentlighed og etablerer en fælles logik for datagrundlag og rapportering. \textcite{IFRS2023S1} fastlægger samtidig en investorrettet global baseline uden dobbelt væsentlighed, hvilket øger spændet mellem globale standarder og EU's krav og skærper kompleksiteten for SMV'er.

\textit{Dobbelt væsentlighed} betyder, at virksomheder skal rapportere både deres påvirkning af mennesker og miljø og hvordan bæredygtighedsforhold påvirker virksomheden finansielt.\parenciteshort{EU2023ESRS} Det udvider datakravet til værdikæde, \textit{governance} og sociale forhold og gør \textit{materialitetsprocessen} til en central del af rapporteringen.

EU-taksonomien supplerer rapporteringen ved at definere, hvilke økonomiske aktiviteter der kan betragtes som miljømæssigt bæredygtige.\parenciteshort{EU2020Taxonomy} Rammeværket kræver, at virksomheder kan dokumentere overensstemmelse med taksonomien og derved knytte finansielle aktiviteter til konkrete miljømæssige mål.

Global Reporting Initiative (GRI) er et globalt, frivilligt rammeværk, som anvendes bredt til sammenlignelig ESG-rapportering, forstået som ens indikatorer, enheder og afgrænsninger mellem virksomheder og over tid. Standarden beskriver en struktureret tilgang til indikatorer og narrativer, der ofte bruges som supplement til regulatoriske krav.\parenciteshort{GRI2021} \textcite{Berg2022AggregateConfusion} peger på, at ESG-data og ratinger fortsat er fragmenterede og vanskelige at sammenligne, hvilket gør frivillige rammer utilstrækkelige uden en stærk datainfrastruktur.

International Organization for Standardization (ISO) IWA 48 samler principper for ESG-implementering og lægger vægt på standardiserede KPI'er, datakvalitet og rapporteringsprincipper.\parenciteshort{ISO2024IWA48} Aftalen er ikke bindende i EU-retlig forstand, men fungerer som et globalt referencepunkt for, hvordan organisationer kan operationalisere ESG i praksis. Implikationen er, at der opstår en forventning om konsistente målinger, sporbarhed og systematisk dokumentation på tværs af sektorer, hvilket styrker behovet for robuste dataflows og governance. For SMV'er betyder det, at selv frivillige rammer kan drive professionalisering af ESG-data og gøre implementering til en løbende kapacitetsopgave.
...
\begin{enumerate}
  \item \textbf{Direktiv (CSRD).} Etablerer rapporteringspligt og overordnede krav, som skal implementeres i national ret.\parenciteshort{EU2022CSRD}
  \item \textbf{Delegerede standarder (ESRS).} Konkretiserer indhold, datapunkter og struktur, så rapportering bliver sammenlignelig og auditerbar.\parenciteshort{EU2023ESRS}
  \item \textbf{Forordning (EU-taksonomien).} Fastlægger en klassifikation af bæredygtige aktiviteter og kobler rapportering til miljømål og finansielle nøgletal.\parenciteshort{EU2020Taxonomy}
  \item \textbf{Frivillige standarder (Global Reporting Initiative, GRI).} Udgør et udbredt supplement, især hvor globale interessenter efterspørger sammenlignelige ESG-oplysninger.\parenciteshort{GRI2021}
\end{enumerate}
...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \endgroup
\TableSource{\parenciteshort{EU2022CSRD,EU2023ESRS,EU2020Taxonomy,GRI2021}}
\end{table}
...
Reguleringen er analytisk interessant: på den ene side øger standarderne sammenligneligheden, på den anden side efterlader de et fortolkningsrum, hvor rapportering kan glide over i \textit{minimum compliance} (opfyldelse af minimumskrav uden aktiv brug af data i styringen) frem for beslutningsrelevant styring.

Hierarkiet bruges som analytisk ramme i resten af rapporten. Direktivniveauet forklarer, hvorfor rapportering er uomgængelig og hvilke pligter der udløses; standardniveauet (ESRS) forklarer, hvordan data skal struktureres, valideres og gøres auditerbare; og forordningsniveauet (taksonomien) forklarer, hvilke aktiviteter der bliver økonomisk relevante. \textbf{Efterfølgende analyser af datamodel, \textit{governance} og værdiforslag skal derfor kunne spores tilbage til disse niveauer.}

\subsubsection{Traceability-matrice som analytisk greb}
\label{subsec:traceability-matrice}

For at gøre kontrakten operationel anvendes en fast \textit{traceability-matrice}, dvs.\ en mapping-tabel, der binder retskilde til datapunkt, input, validering, beregning, output og audit-evidens. I hovedteksten vises en gennemarbejdet trace som eksempel, mens den fulde matrix for MVP-scope er flyttet til bilag (tabel \ref{tab:traceability-matrix-full}) og fungerer som evidensregister med entydige ID'er. Matricen genbruges i software- og evalueringsafsnittene, så hver central påstand kan spores tilbage til et regulatorisk krav og et konkret dataflow.

B2 betegner energimodulet i Scope 2 i MVP'ens moduloversigt (bilag \ref{app:supplerende-figurer-og-tabeller}, tabel \ref{tab:app-moduloversigt}).

\begin{table}[htbp]
  \caption{Traceability-trace (eksempel) for B2, der binder retskilde, datapunkt, datafelter og auditspor.}
  ...
  \begin{tabularx}{\textwidth}{l >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{0.12\textwidth} >{\raggedright\arraybackslash}p{0.12\textwidth} >{\raggedright\arraybackslash}p{0.11\textwidth} >{\raggedright\arraybackslash}p{0.11\textwidth} >{\raggedright\arraybackslash}p{0.11\textwidth} >{\raggedright\arraybackslash}X}
    ...
    \midrule
    M1 & CSRD \lawart{19a}, \lawart{29a} (Dir. EU 2022/2464) & ESRS E1-5/E1-6 (energi) & El/varme (kWh), emissionsfaktorer & Enheder, periodelås, kilde angivet & CO$_2$e = aktivitet $\times$ EF; energisum pr. periode & Scope 2 CO$_2$e; energiforbrug pr. periode & Kilde-ID, EF-version, ændringslog, godkendelse af dataejer \\
    \bottomrule
  \end{tabularx}
  \endgroup
  \TableSource{\parenciteshort{EU2022CSRD,EU2023ESRS,GHGProtocol2004}}
  \TableNote{Fuld matrix for MVP-scope med ID'er fremgår af bilagstabel \ref{tab:traceability-matrix-full}.}
\end{table}

\subsubsection{Dækningsafgrænsning for MVP-scope}
\label{subsec:daekning-traceability}

MVP'ens modulstruktur er bred, men rapportens evidensscope er afgrænset til de moduler, der faktisk demonstreres og evalueres: B2 (energi/Scope~2), C5 (affald) og S1 (arbejdsmiljø). Disse tre moduler udgør matrix-ID M1--M3 og har fulde traceability-traces i bilagstabel \ref{tab:traceability-matrix-full}, mens hovedteksten kun viser et gennemarbejdet eksempel. Øvrige moduler er kun specificeret på struktur- og designniveau (bilag \ref{app:teknisk-dokumentation} og tabel \ref{tab:app-moduloversigt}), hvilket betyder, at rapporten ikke dokumenterer alle ESRS-datapunkter. Udvælgelsen følger de mest centrale sektorrisici og de datapunkter, som MVP'en faktisk implementerer. For kravene i tabel \ref{tab:krav-prioritering} er 6 ud af 8 krav operationaliseret i MVP'en (alle markeret som MVP-krav).

\subsubsection{Gennemgående regulatoriske principper}
\label{subsec:gennemgaaende-regulatoriske-principper}

På tværs af retskilderne går en række gentagende principper, der forklarer, hvorfor ESG-rapportering kræver systematik. Proportionalitet og faseindføring skalerer og udskyder kravene, hvilket skaber et gradvist men vedvarende implementeringspres.\parenciteshort{EU2022CSRD,Erhvervsstyrelsen2025StopClock} \textit{Dobbelt væsentlighed} gør materialitetsprocessen til et kernekrav og udvider datagrundlaget til både påvirkning og finansiel risiko.\parenciteshort{EU2023ESRS} Dokumentations- og sporbarhedskrav følger af standardernes struktur og taksonomiens klassifikationslogik og nødvendiggør \textit{auditspor} og konsistente datakilder.\parenciteshort{EU2023ESRS,EU2020Taxonomy} \textcite{Finanstilsynet2025ESGRisk} viser, at finansielt tilsyn skaber en risikobaseret forventning om ESG-data, der forstærker kravene uden for den direkte rapporteringspligt.

\subsubsection{Implementering i dansk ret og praksis}
\label{subsec:implementering-i-dansk-ret}

Som direktiv forudsætter CSRD national implementering. I Danmark sker implementeringen via lov nr 480 af 22/05/2024, som ændrer Årsregnskabsloven, bl.a.\ \lawpar{99a} om bæredygtighedsoplysninger i ledelsesberetningen, og som operationaliseres gennem Erhvervsstyrelsens vejledninger og værktøjer til SMV'er.\parenciteshort{EU2022CSRD,Lov2024CSRD,Aarsregnskabsloven2024,Erhvervsstyrelsen2025ESGTemplate,Virksomhedsguiden2025VSMEIntro} \lawpar{99b} er senere ophævet ved lov 2024/1668, og anvendes derfor ikke som eksempel her.\parencite{Lov2024Ophaevelse99b} I praksis mødes virksomhederne ofte gennem nationale kanaler som myndigheder, revisorer og finansielle institutioner; \textcite{Finanstilsynet2025ESGRisk} viser, at bankernes ESG-risikostyring gør data til en forudsætning for kredit, også når rapportering formelt er frivillig.\parencite{DanskErhvervFSR2025CSRDTimeline}
...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \endgroup
  \TableSource{\parencite{Lov2024CSRD,Aarsregnskabsloven2024,Erhvervsstyrelsen2025ESGTemplate,Finanstilsynet2025ESGRisk}}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.24\textwidth} >{\raggedright\arraybackslash}p{0.30\textwidth} >{\raggedright\arraybackslash}X}
    ...
    GRI & Frivilligt rammeværk, anvendes globalt. & Indikatorbaseret rapportering med fokus på væsentlige forhold og sammenlignelighed på tværs af virksomheder og over tid. \\
    \bottomrule
  \end{tabularx}
  \endgroup
  \TableSource{\parenciteshort{EU2022CSRD,EU2023ESRS,EU2020Taxonomy,GRI2021}}
...
For at gøre reguleringen operationel i rapporteringen kan centrale retskilder bindes til konkrete artikelhenvisninger. EU-lovgivning angives typisk med artikelnumre, mens danske love bruger paragraftegn; i dansk implementering af CSRD forankres bæredygtighedsoplysninger i Årsregnskabslovens \lawpar{99a}. Udvalgte eksempler på formater og relevans fremgår af tabel \ref{tab:lovhenvisninger-eksempler}.
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.30\textwidth} >{\raggedright\arraybackslash}p{0.22\textwidth} >{\raggedright\arraybackslash}X}
    ...
    Årsregnskabsloven (DK) & \lawpar{99a} & Danske krav til bæredygtighedsoplysninger i ledelsesberetningen som led i CSRD-transponeringen. \\
  ...
  \end{tabularx}
  \endgroup
  \TableSource{\parenciteshort{EU2022CSRD,Aarsregnskabsloven2024,EU2020Taxonomy,EU2016GDPR}}
  \TableNote{Paragraffer i dansk lovgivning angives typisk med \lawpar{...} (fx \lawpar{99a} i Årsregnskabsloven).}
\end{table}
...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \endgroup
  \TableSource{\parenciteshort{EU2022CSRD,Lov2024CSRD,Aarsregnskabsloven2024,EU2023ESRS}}
\end{table}

Et gennemført eksempel kan illustrere kæden fra EU-hjemmel til systemkrav: Direktiv (EU) 2022/2464 (CSRD) \lawart{19a} og \lawart{29a} fastlægger, at bæredygtighedsoplysninger skal indgå i ledelsesberetningen og være digitalt rapporterbare. I Danmark implementeres kravet via lov nr 480 af 22/05/2024, som ændrer årsregnskabsloven, og operationaliseres gennem Erhvervsstyrelsens VSME-skabelon. I MVP'en oversættes dette til datapunktet ESRS E1 (B2), hvor energiforbrug indtastes i kWh, valideres (enhed og periode), beregnes til CO$_2$e med emissionsfaktor, og logges med kilde-ID, EF-version og sign-off i auditsporet. Output er et rapporterbart Scope 2-tal, som kan efterprøves i revision.
...
\textcite{Virksomhedsguiden2025SMVDefinition} fastlægger, at SMV'er defineres efter EU's størrelsesgrænser og ofte ligger uden for den direkte CSRD-pligt, men påvirkes indirekte gennem kundekrav, banker og leverandørrelationer. \textcite{Erhvervsstyrelsen2025ESGTemplate} og \textcite{GrantThorntonDK2025Omnibus} peger på, at dette gør frivillighed til en markedsforventning snarere end et reelt valg.

\textcite{Virksomhedsguiden2025VSMEIntro} introducerer VSME som frivillig standard for SMV'ers bæredygtighedsrapportering. EU-Kommissionens anbefaling bygger på den VSME-standard, som EFRAG har udviklet, og beskriver standardens frivillige karakter.\parencite{EU2025VSMERecommendation} \textcite{Erhvervsstyrelsen2025ESGTemplate} præciserer, at standarden er opbygget af et basismodul og et udvidet modul, at dobbelt væsentlighed ikke kræves, og at Erhvervsstyrelsen stiller en ESG-skabelon til rådighed for rapporteringen.
