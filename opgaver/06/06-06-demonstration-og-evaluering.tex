...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{l X X}
    ...
    \midrule
    Energi (B2) & Valideret input, beregnet resultat og audit-log. & Dataindsamling, validering, beregning, audit-log. \\
...
Resultaterne viser, at MVP'en opfylder de centrale MVP-krav om dataindsamling, validering, beregning og sporbarhed. Brugerflowet giver en klar progression fra profil til modul og review, og output kan eksporteres i de forventede formater.\parencite{InternalSoftwareSpec2026,InternalSoftwareDetails2026}
