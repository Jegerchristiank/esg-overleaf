...
% Keep table styling scoped to each float to avoid rowcolors leaking into non-table tabulars.
\AtBeginEnvironment{table}{\begingroup}
\AtEndEnvironment{table}{\endgroup}
